...
class Controller_Site extends Controller
{
    ...
    public function action_index()
    {
      ...
      View::set_global("tpl_dir", str_replace('\\', '/',DOCROOT)."application/views/");
      View::set_global("url_actual", url::base().((Kohana::$index_file)?(Kohana::$index_file."/"):"").$this->application_context->get_actual_seo());
      $url_homepage=Service_Route::get_language_index_seo($this->application_context->get_actual_language_id());
      View::set_global("url_homepage", ($url_homepage != "index")?(url::base().$url_homepage):url::base());
      ...
      View::set_global("web_setup",$this->application_context->get_web_setup_data());
      View::set_global("web_owner",$this->application_context->get_web_owner_data());
      ...
      else
      {
          ...
          $data_controller_action   =$this->application_context->get_data_manipulation_controller_action();
          ...
          if($data_controller_action)
          {
              ...
              if(!$this->application_context->validate_data_manipulation_secure_code($data_controller_action,$data_controller))
              {
                  throw new Kohana_Exception("Validační hash kód formuláře je chybný!");
              }
    ...
    public function action_redirect()
    {
        ...
        if($redirect) Request::instance()->redirect(url::base().$redirect);
    }
