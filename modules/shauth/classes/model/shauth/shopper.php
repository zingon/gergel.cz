...
/**
 * Default auth shopper
 *
 * POZOR TENTO MODEL NEUPRAVOVAT - O SLOŽKU VÝŠ JE ODVOZENÝ MODEL - UPRAVUJTE TEN !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 * 
 */
class Model_Shauth_Shopper extends ORM {
	...
	public function save()
	{
		...
		{
			$this->_object['password'] = Shauth::instance()->hash_password($this->_object['password']);
		}
