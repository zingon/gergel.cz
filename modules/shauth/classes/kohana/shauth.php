...
abstract class Kohana_Shauth {
	...
	public static function instance()
	{
		...
		if ( ! isset(Shauth::$_instance))
		{
			// Load the configuration for this type
			$config = Kohana::config('shauth');
			...
			$class = 'Shauth_'.ucfirst($type);

			// Create a new session instance
			Shauth::$_instance = new $class($config);
		}

		return Shauth::$_instance;
	}

	/**
	 * Create an instance of Shauth.
	 *
	 * @return  Shauth
	 */
	public static function factory($config = array())
	{
		return new Shauth($config);
	}
	...
	public function __construct($config = array())
	{
		...
		$config['salt_pattern'] = preg_split('/,\s*/', Kohana::config('shauth')->get('salt_pattern'));
