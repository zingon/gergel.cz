...
class Kohana_Pagination {
	...
	protected $config = array(
		'current_page'      => array('source' => 'query_string', 'key' => 'page', 'value' => 1),
		'total_items'       => 0,
		'items_per_page'    => 10,
			...
			else
			{
				switch ($this->config['current_page']['source'])
				{
					...
					case 'route':
						...
						break;
                                        default:
                                                $this->current_page = $this->config['current_page']['value'];
                                                break;
				}
			}
			...
			case 'route':
				return URL::site(Request::current()->uri(array($this->config['current_page']['key'] => $page))).URL::query();
                        default:
                                ...
                                return url::base().$this->config['current_page']['source']."/".$page;
		}
