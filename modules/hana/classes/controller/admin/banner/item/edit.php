...
class Controller_Admin_Banner_Item_Edit extends Controller_Hana_Edit
{
    ...
    protected function _form_action_main_postvalidate($data) {
       ...
       if(isset($_FILES["main_image_src"]) && $_FILES["main_image_src"]["name"])
       {
           ...
           $this->module_service->insert_image("main_image_src", $this->subject_dir, $image_settings, "banner-".$this->orm->language_id);
       }
