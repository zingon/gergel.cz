...
class Controller_Admin_Product_Shipping_List extends Controller_Hana_List
{
    ...
    protected function _column_definitions()
    {
        ...
        $this->auto_list_table->column("popis")->label("Popis")->css_class("txtLeft")->item_settings(array("maxlenght"=>100))->set();
        //$this->auto_list_table->column("cena")->type("text")->label("Cena v Kč")->css_class("txtRight")->width(150)->set();
