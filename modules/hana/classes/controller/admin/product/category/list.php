...
class Controller_Admin_Product_Category_List extends Controller_Hana_List
{
    ...
    {
        $this->auto_list_table->column("id")->label("# ID")->width(30)->css_class("txtCenter")->sequenceable()->filterable(array("col_name"=>"product_categories.id"))->set();
        ...
        $this->auto_list_table->column("uvodni_popis")->label("Popis")->css_class("txtLeft")->item_settings(array("maxlenght"=>100))->sequenceable()->filterable()->set();
