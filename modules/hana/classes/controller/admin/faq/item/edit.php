...
class Controller_Admin_Faq_Item_Edit extends Controller_Hana_Edit
{
    ...
    protected function _column_definitions()
    {
        ...
        $this->auto_edit_table->row("nazev")->type("textarea")->label("Otázka")->condition("Položka musí mít minimálně 3 znaky.")->set();
        ...
        $this->auto_edit_table->row("popis")->type("editor")->label("Odpověď")->set();
