...
<table class="orderTable">
   ...
   <tr>
      ...
      <tr>
       <td colspan="2" class="orderItems">          
          <table>  
            ...
            <tr><td colspan="4" class="priceLabelCol">Cena (sleva) za platební metodu: </td><td class="priceCol">{$order.order_payment_price} Kč</td></tr>   
            <tr><td colspan="5">&nbsp;</td></tr>
     ...
     <tr>
       <td colspan="2" class="orderAddition p20">
         <p style="font-weight: bold;">Poznámka zákazníka:</p><br />
         <p>{$order.order_shopper_note}</p>
       </td>
     </tr>
     <tr> 
       <td colspan="2" class="orderAddition p20">
         <p style="font-weight: bold;">Sphere program:</p><br />
