...
var loadConfigFile = function (type) {
	...
	if(type == 'user') {
		var url = '../media/admin/js/filemanager/scripts/filemanager.config.js';
	} else {
		var url = '../media/admin/js/filemanager/scripts/filemanager.config.js.default'
	}
...
var fileConnector = '/admin/file_manager';
...
if($.urlParam('langCode') != 0 && file_exists ('../media/admin/js/filemanager/scripts/languages/'  + $.urlParam('langCode') + '.js')) config.options.culture = $.urlParam('langCode');

var lg = [];
$.ajax({
  url: '../media/admin/js/filemanager/scripts/languages/'  + config.options.culture + '.js',
  async: false,
  dataType: 'json',
...
var getFolderInfo = function(path) {
	...
	$('#fileinfo').html('<img id="activity" src="../media/admin/js/filemanager/images/wait30trans.gif" width="30" height="30" />');
...
$(function(){
	...
	if(config.edit.enabled) {
		loadCSS('../media/admin/js/filemanager/scripts/CodeMirror/lib/codemirror.css');
		loadCSS('../media/admin/js/filemanager/scripts/CodeMirror/theme/' + config.edit.theme + '.css');
		loadJS('../media/admin/js/filemanager/scripts/CodeMirror/lib/codemirror.js');
		loadJS('../media/admin/js/filemanager/scripts/CodeMirror/addon/selection/active-line.js');
		loadJS('../media/admin/js/filemanager/scripts/CodeMirror/dynamic-mode.js');
	}
	if(!config.options.fileRoot) {
		fileRoot = '/media/userfiles/';
	} else {
	...
	/** load searchbox */
	if(config.options.searchBox === true)  {
		loadJS("../media/admin/js/filemanager/scripts/filemanager.liveSearch.min.js");
	} else {
		$('#search').remove();
	}
