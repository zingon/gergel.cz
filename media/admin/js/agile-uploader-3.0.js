(function($) {
	...
	*/
	...
	$.fn.agileUploader.defaults = {
		...
		flashSrc: '../../../../../../media/admin/swf/agile-uploader.swf',
		flashWidth: 25,
		flashHeight: 22,
		...
		flashVars: {
			...
			file_limit: -1,
			button_up:'../../../../../../media/admin/swf/add-file.png',
			button_over:'../../../../../../media/admin/swf/add-file.png',
			button_down:'../../../../../../media/admin/swf/add-file.png'
		},
		progressBarColor: '#000000',
		attachScrollSpeed: 1000,		
		removeIcon: '../../../../../../media/admin/swf/trash-icon.png',
		genericFileIcon: '../../../../../../media/admin/swf/file-icon.png',
		maxPostSizeMessage: 'Vložené soubory přesáhly stanovený limit.',
		maxFileMessage: 'Byl překročen maximální počet souborů (zbylé se ignorují).',
		duplicateFileMessage: 'Tento soubor už byl přiložen',
		notReadyMessage: 'Formulář nelze odeslat, některé soubory se stále načítají.',
