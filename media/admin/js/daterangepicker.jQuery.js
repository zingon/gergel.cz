...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			{text: 'Dnes', dateStart: 'today', dateEnd: 'today' },
			{text: 'Posledních 7 dní', dateStart: 'today-7days', dateEnd: 'today' },
			{text: 'Od začátku měsíce', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: 'Od začátku roku', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
			{text: 'Předchozí měsíc', dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } }
		...
		presets: {
			specificDate: 'Specifické datum', 
			allDatesBefore: 'Všechny dny před', 
			allDatesAfter: 'Všechny dny po', 
			dateRange: 'Rozmezí od-do'
		},
		rangeStartTitle: 'Počátek',
		rangeEndTitle: 'Konec',
		nextLinkText: 'Další',
		...
		dateFormat: 'd.m.yy',//'m/d/yy', // date formatting. Available formats: http://docs.jquery.com/UI/Datepicker/%24.datepicker.formatDate
	...
	function showRP(){
	  // uprava - pozicovat v adminu muzu az v dobe kliknuti
